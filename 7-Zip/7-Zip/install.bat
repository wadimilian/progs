...
:UnSet_Assoc
reg.exe delete "HKCR\.%~1" /VE /F
reg.exe delete "HKCR\%PROGRAM_ID%%~1" /F
reg.exe delete "HKCU\Software\Classes\%PROGRAM_ID%%~1" /F
reg.exe delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.%~1\OpenWithProgids" /V "%PROGRAM_ID%%~1" /F
exit /B
...
reg.exe add    "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.%~1\OpenWithProgids" /V "%PROGRAM_ID%%~1" /T REG_NONE /F
